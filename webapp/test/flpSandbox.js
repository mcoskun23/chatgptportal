		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chat GPT Portal",
									"targetURL": "#comnttchatgptportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttchatgptportal-display": {
								"semanticObject": "comnttchatgptportal",
								"action": "display",
								"description": "Chat GPT Portal",
								"title": "Chat GPT Portal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.chatgptportal",
									"url": sap.ui.require.toUrl("com/ntt/chatgptportal")
								}
							}
						}
					}
